...
APT="nginx libnginx-mod-http-fancyindex subversion ssl-cert php8.4-common php8.4-fpm libfcgi0ldbl php8.4-cli php8.4-dev php8.4-xml php8.4-curl php8.4-xmlrpc php-json php8.4-mbstring php8.4-opcache php8.4-zip ${geoip} ${mcrypt}"
apt_install $APT
