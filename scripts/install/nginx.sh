...
# APT="nginx libnginx-mod-http-fancyindex subversion ssl-cert php8.4-fpm libfcgi0ldbl php8.4-cli php8.4-dev php8.4-xml php8.4-curl php8.4-xmlrpc php-json php8.4-mbstring php8.4-opcache php8.4-zip php8.4-bcmath ${geoip} ${mcrypt}"
  APT="nginx libnginx-mod-http-fancyindex subversion ssl-cert php8.5-fpm libfcgi0ldbl php8.5-cli php8.5-dev php8.5-xml php8.5-curl php8.5-mbstring php8.5-zip php8.5-bcmath ${geoip} ${mcrypt}"
...
for version in $phpv; do
    sed -i -e "s/post_max_size = 8M/post_max_size = 240M/" \
