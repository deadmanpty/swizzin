...
APT="nginx nginx-module-fancyindex subversion ssl-cert php-fpm libfcgi0ldbl php-cli php-dev php-xml php-curl php-xmlrpc php-json php-mbstring php-opcache php-zip php-bcmath ${geoip} ${mcrypt}"
...
# APT="nginx libnginx-mod-http-fancyindex subversion ssl-cert php8.5-fpm libfcgi0ldbl php8.5-cli php8.5-dev php8.5-xml php8.5-curl php8.5-xmlrpc php8.5-mbstring php8.5-zip php8.5-bcmath ${geoip} ${mcrypt}"
