...
dependencies="whiptail git sudo curl wget lsof rsyslog fail2ban apache2-utils build-essential apt-transport-https uuid-runtime gnupg2 net-tools cracklib-runtime unzip ccze cron"
