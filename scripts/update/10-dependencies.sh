...
dependencies="whiptail git sudo curl wget lsof rsyslog fail2ban apache2-utils tcl tcl-dev build-essential apt-transport-https uuid-runtime bc jq gnupg2 net-tools cracklib-runtime unzip ccze cron"
