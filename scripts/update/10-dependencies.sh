...
dependencies="whiptail git sudo curl wget lsof rsyslog fail2ban apache2-utils build-essential apt-transport-https bc uuid-runtime jq gnupg2 net-tools cracklib-runtime unzip ccze cron c-ares"
