...
dependencies="whiptail git sudo curl wget lsof rsyslog fail2ban apache2-utils build-essential apt-transport-https bc uuid-runtime tcl tcl-dev jq gnupg2 net-tools cracklib-runtime unzip ccze cron"
